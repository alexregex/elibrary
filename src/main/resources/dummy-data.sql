...
START TRANSACTION;
USE `elibrarydb`;
INSERT INTO `elibrarydb`.`BOOK` (`id`, `title`, `author`, `publishing`, `cover`, `link`, `description`, `date_add`, `user_id`) VALUES (1, 'Spring MVC Beginners Guide', 'Amuthan Ganeshan', 'Packt Publishing Ltd', 'spring-mvc-beginners-guide-2nd-1.jpg', 'spring-mvc-beginners-guide-2nd.pdf', 'This book has a very clear aim to introduce you to the incredible simplicity and power of Spring MVC. The best way to test whether or not you really understand a concept is to try to teach it.', '2017-10-19', 1);
