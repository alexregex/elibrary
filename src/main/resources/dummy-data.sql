...
START TRANSACTION;
USE `elibrarydb`;
INSERT INTO `elibrarydb`.`BOOK` (`id`, `title`, `author`, `publishing`, `cover`, `link`, `description`, `date_add`, `user_id`) VALUES (1, 'Java 8.The Complete Reference,8th edition', 'Herbert Schildt', 'McGraw Hill Professional', 'java_the_complete_reference_8th_edition_herbert_schildt.jpg', 'Herbert_Schildt_Java_The_Complete_Reference_8th_Edition.pdf', 'The Definitive Java Programming Guide. In Java: The Complete Reference, Eighth Edition, bestselling programming author Herb Schildt shows you everything you need to develop, compile, debug, and run Java programs.', '2017-12-10', 1);
INSERT INTO `elibrarydb`.`BOOK` (`id`, `title`, `author`, `publishing`, `cover`, `link`, `description`, `date_add`, `user_id`) VALUES (2, 'Clean Code. 1st Edition', 'Robert C. Martin', 'Prentice Hall', 'martin_flower_cleancode.jpg', 'Clean_Code_A_Handbook_of_Agile_Software_Craftsmanship_1st_Edition.pdf', 'Even bad code can function. But if code isn t clean, it can bring a development organization to its knees. Every year, countless hours and significant resources are lost because of poorly written code.', '2017-11-04', 1);
INSERT INTO `elibrarydb`.`BOOK` (`id`, `title`, `author`, `publishing`, `cover`, `link`, `description`, `date_add`, `user_id`) VALUES (3, 'Effective Java (3rd Edition)', 'Joshua Bloch', 'Amazon Inc', 'effective_java_3rd _edition.png', 'Effective_Java_3rd_edition.docx', 'Java has changed dramatically since the previous edition of Effective Java was published shortly after the release of Java 9. This Jolt award-winning classic has now been thoroughly updated to take full advantage.', '2018-01-14', 2);
INSERT INTO `elibrarydb`.`BOOK` (`id`, `title`, `author`, `publishing`, `cover`, `link`, `description`, `date_add`, `user_id`) VALUES (4, 'Spring in action. Fourth Edition', 'Craig Walls', 'Packt Publishing Ltd', 'spring_in_action.png', 'Spring_in_action.rtf', 'This book has a very clear aim to introduce you to the incredible simplicity and power of Spring MVC. The best way to test whether or not you really understand a concept is to try to teach it.', '2017-09-09', 1);
