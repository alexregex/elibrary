        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                    <a class="dropdown-item" href="<spring:url value="/books/add" />">Add new book</a>
                    <a class="dropdown-item" href="<spring:url value="/books/admin-booklist" />">List of books</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown02">
                    <a class="dropdown-item" href="<spring:url value="/admin-userslist" />">List of users</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<spring:url value="/books/all" />">Exit</a>
            </li>
        </ul>
    </div>
</nav>
...
<script src="/static/js/bs4/bootstrap.min.js"></script>
